...
int countMed(lire L, adrapt Q); /**hitung ada berapa obat yang dimiliki apotik*/ //manuel
int countApt(lire L, admed M); /**hitung ada berapa apotik yang punya obat*/ //bagja
